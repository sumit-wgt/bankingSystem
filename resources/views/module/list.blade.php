 ...
 <!-- Main Sidebar Container Ends-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row">
        <div class="col-12">
          <a class="btn btn-primary float-sm-right" href="{{ url('module-add') }}">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                @if(isset($getModule))
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('/module-status', ['id' => $module->id]) }}">
                    ...
                    <td>
                      <a href="{{ url('/module-edit', ['id' => $module->id]) }}">
                        <i class="fa fa-edit" title="Edit"></i>
                      </a>
                      &nbsp;
                      <a onclick="return checkDelete()" href="{{ url('/module-delete', ['id' => $module->id]) }}">
