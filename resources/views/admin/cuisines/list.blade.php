 ...
 <!-- Main Sidebar Container Ends-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row">
        <div class="col-12">
          <a class="btn btn-primary float-sm-right" href="{{ route('cuisines-add') }}">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                <td>{{$cuisine->name}}</td>
                <td>{{ date('Y-m-d'),strtotime($cuisine->created_at)}}</td>
                <td>
                  <a href="{{ url('/cuisines-status', ['id' => $cuisine->id]) }}">
                  @if($cuisine->status == 1)
                ...
                <td>
                  <a href="{{ url('/cuisines-edit', ['id' => $cuisine->id]) }}">
                    <i class="fa fa-edit" title="Edit"></i>
                  </a>
                  &nbsp;
                  <a onclick="return checkDelete()" href="{{ url('/cuisines-delete', ['id' => $cuisine->id]) }}">
