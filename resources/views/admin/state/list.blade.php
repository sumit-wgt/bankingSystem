 ...
 <!-- Main Sidebar Container Ends-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row">
        <div class="col-12">
          <a class="btn btn-primary float-sm-right" href="{{ route('state-add') }}">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td>
                  <a href="{{ url('/state-status', ['id' => $state->id]) }}">
                  @if($state->status == 1)
                ...
                <td>
                  ...
                  &nbsp;
                  <a onclick="return checkDelete()" href="{{ url('/state-delete', ['id' => $state->id]) }}">
