 ...
 <!-- Main Sidebar Container Ends-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Area/Zipcode</li>
            </ol>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-12">
          <a class="btn btn-primary float-sm-right" href="{{ route('area-add') }}">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td>
                  <a href="{{ url('/area-status', ['id' => $area->id]) }}">
                  @if($area->status == 1)
                ...
                <td>
                  <a href="{{ url('/area-edit', ['id' => $area->id]) }}">
                    <i class="fa fa-edit" title="Edit"></i>
                  </a>
                  &nbsp;
                  <a onclick="return checkDelete()" href="{{ url('/area-delete', ['id' => $area->id]) }}">
